                                ...
                                Row(
                                    ...
                                    IconButton(
                                        ...
                                        Icon(
                                            ...
                                            tint = if (numberOfBays > 1) MaterialTheme.colorScheme.primary else Color.Gray
                                        )
                                    }
                                    ...
                                    IconButton(
                                        ...
                                        Icon(
                                            ...
                                            tint = if (numberOfBays < 10) MaterialTheme.colorScheme.primary else Color.Gray
                                        )
                                    }
                                }
                            ...
                            Card(
                                ...
                                Column(Modifier.padding(16.dp)) {
                                    Row(
                                        ...
                                        Text(serviceForm.type, color = MaterialTheme.colorScheme.primary, fontWeight = FontWeight.Bold)
                                        Row {
                                            Text(
                                                if (serviceForm.isExisting) "Existant" else "Nouveau",
                                                style = MaterialTheme.typography.labelSmall,
                                                color = if (serviceForm.isExisting) MaterialTheme.colorScheme.primary else Color.Green,
