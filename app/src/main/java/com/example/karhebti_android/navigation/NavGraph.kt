...
sealed class Screen(val route: String) {
    ...
    object ReservationsList : Screen("reservations") {
        fun createRoute(garageId: String? = null) = if (garageId != null) "reservations?garageId=$garageId" else "reservations"
    }
...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(
            route = "reservations?garageId={garageId}",
            arguments = listOf(navArgument("garageId") {
