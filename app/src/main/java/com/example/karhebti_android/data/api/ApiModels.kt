...
data class GarageResponse(
    ...
    @SerializedName("proprietaireId") val proprietaireId: Any? = null,
    val createdAt: Date? = null,
    val updatedAt: Date? = null
) {
    // Helper method to get proprietaire ID as String
    fun getProprietaireId(): String? {
        return when (proprietaireId) {
            is String -> proprietaireId
            is Map<*, *> -> (proprietaireId["_id"] as? String) ?: (proprietaireId["id"] as? String)
            else -> null
        }
    }
}
